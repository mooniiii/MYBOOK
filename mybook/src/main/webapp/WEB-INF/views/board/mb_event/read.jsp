                    ...
                    <div class="readBtn">
                    	<c:choose>
							<c:when test="${read.id eq aaaa.id}">
								<button class="readModifyBtn"><a href="/board/mb_event/modify?bno=${read.bno}">수정하기</a></button>
								<button class="readDeleteBtn"><a href="/board/mb_event/remove?bno=${read.bno}">삭제하기</a></button>
	                       	</c:when>
